      ...
      <div class="bg-gray-50">
        <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <p className='text-xl mr-4'>Lenovo has launched a new gaming-oriented laptop in India, the Lenovo Legion 5 Pro. The brand had unveiled the laptop earlier this year for global markets. The Lenovo Legion 5 Pro comes as an advanced variant of the Lenovo Legion 5 that is already on sale in the country. It packs the AMD Ryzen 5000 series CPU, which is the latest CPU lineup from the brand for laptops. The laptop also has the Nvidia RTX 3000 series GPU, which is the latest GPU lineup from the company. The Lenovo Legion 5 Pro is a direct competitor to the Asus Zephyrus G15 that was launched in India a couple of months ago. Anyway, let us have a look at the Lenovo Legion 5 Pro price.</p>
