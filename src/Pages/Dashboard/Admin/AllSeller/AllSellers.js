...
const AllSellers = () => {
  ...
  useEffect(() => {
    axios
      .get("https://used-laptop-server-iota.vercel.app/lists/seller")
  ...
  const handleDeleteSeller = (seller) => {
    ...
    fetch(
      `https://used-laptop-server-iota.vercel.app/users/${seller._id}`,
      {
        method: "DELETE",
      }
    )
  ...
  const handleVerifySeller = (seller) => {
    ...
    fetch(
      `https://used-laptop-server-iota.vercel.app/sellers/${seller._id}`,
      {
        method: "PATCH",
        headers: {
